...
<head>
    ...
    <title>Editar usuario - SGV Autos</title>
            ...
            <div class="sgv-panel" style="max-width: 560px;">
                ...
                <form action="./user_update.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="Fullname" class="form-control" id="InputName" value="<?php echo htmlspecialchars($fullname); ?>">
                    </div>
                    <div class="mb-3">
                        <label for="InputEmail" class="form-label">Correo electrónico</label>
                        <input type="email" name="email" class="form-control" id="InputEmail" value="<?php echo htmlspecialchars($_GET["user"]); ?>">
                    </div>
                    <div class="mb-3">
                        <label for="InputPassword" class="form-label">Contraseña</label>
                        <input type="password" name="password" class="form-control" id="InputPassword" value="<?php echo htmlspecialchars($password); ?>">
                    </div>
