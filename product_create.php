...
<head>
    ...
    <title>Nuevo producto - SGV Autos</title>
            ...
            <div class="sgv-panel" style="max-width: 560px;">
                ...
                <form action="./product_save.php" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" name="Codigo" class="form-control" id="InputCodigo" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="Existencia" class="form-control" id="InputExistencia" min="0" required>
                    </div>
                    <div class="mb-3">
                        <label for="InputPrecio" class="form-label">Precio</label>
                        <input type="number" name="Precio" class="form-control" id="InputPrecio" min="0" step="0.01" required>
                    </div>
